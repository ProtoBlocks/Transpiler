  ...
  steps: [
    {
      ...
      recipients: ["Alice"],
      name: "Input",
      function: async ({ bob: Bob, alice: Alice }) => {
        const Nonce = nonce();
        Prover.send({
          Nonce: Nonce,
        });
    ...
    },
    {
      ...
      recipients: ["Bob"],
      name: "AliceProve",
      function: async ({ alice: Alice, bob: Bob }) => {
        const Signature = sign(
          Bob.Input.Nonce + Bob.Id,
          Alice.Input.AliceSecret
        );
        const Nonce = nonce();
        Prover.send({
          Signature: Signature,
    ...
    },
    {
      ...
      function: async ({ bob: Bob, alice: Alice }) => {
        const Signature = sign(
          Alice.AliceProve.Nonce + Alice.Id,
          Bob.Input.BobSecret
        );
