...
const { Protocol: __PROTOBLOCKS_PROTOCOL__ } = require("protoblocks");

const ISO_2_Pass_Unilateral_Authentication_Over_CCF =
  new __PROTOBLOCKS_PROTOCOL__({
    ...
    steps: [
      {
        ...
        recipients: ["Prover"],
        name: "Challenge",
        function: async ({ verifier: Verifier, prover: Prover }) => {
          const Nonce = nonce();
          Prover.send({
            Nonce: Nonce,
          });
      ...
      },
      {
        ...
        recipients: ["Verifier"],
        name: "Response",
        function: async ({ prover: Prover, verifier: Verifier }) => {
          const Hash = hash(
      ...
      },
      {
        ...
        recipients: [],
        name: "Verify",
        function: async ({ verifier: Verifier }) => {
          const Hash = hash(
